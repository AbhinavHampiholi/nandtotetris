/*
    ...
    Comments: This is a tokenizer, that takes as input a .jack file and spits out a .xml file which 
...
int main(int argc, char *argv[]){
    if( argc > 0 )
        ...
        cerr<<"Error:Filename not provided or too many arguments\n"; return 0;
    }
    pushkeyandsym();
    removeMulti();
    removeSingle();
