...
void compileVarDec(){
    ...
    tno++;
    //tno++;
    cout<<"on exiting VarDec:"<<Token[tno].data<<endl;
}

void compileLetStatement(){
    cout<<"in compileLetStatement\n";
    tno++;//going over <let>
    tno++;//going over let
    string variable = Token[tno].data;
    ...
    if(Token[tno].data == "["){
        ...
        cout<<"in compileLetStatement:"<<ss<<endl;
        tno++;//going past ;
        tno++; //going past </let>
    }
}
...
void compileStatements(){
    cout<<"in compileStatements\n";
    tno++;
    cout<<"token.data is "<<Token[tno].data<<endl;
